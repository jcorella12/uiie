...
export type DocumentoTipo = 'contrato' | 'plano' | 'memoria_tecnica' | 'dictamen' | 'acta' | 'lista_verificacion' | 'resolutivo' | 'fotografia' | 'certificado_cre' | 'acuse_cre' | 'evidencia_visita' | 'otro'
